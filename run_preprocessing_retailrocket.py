...
PATH_PROCESSED = 'data/retailrocket/single/'
FILE = 'events'
...
if __name__ == '__main__':
    ...
    if METHOD == "info":
        ...
        pp.preprocess_days_test_min_date(PATH, FILE,PATH_PROCESSED, MIN_ITEM_SUPPORT, MIN_SESSION_LENGTH, MAX_SESSION_LENGTH, DAYS_TEST, MIN_DATE)
